...
```shell
npm i github:your_github_username/au-mod-c
# or if you use bitbucket
npm i bitbucket:your_github_username/au-mod-c
# or if you use gitlab
npm i gitlab:your_github_username/au-mod-c
# or plain url
npm i https:/github.com/your_github_username/au-mod-c.git
```

Then load the plugin in app's `main.ts` like this.
```js
aurelia.use.plugin('au-mod-c');
